          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-12 doc-header">
                <a class="btn btn-success" href="../estagiario/estagiario.php"><i class="mdi mdi-home me-2"></i>Volta ao Início</a>
                <h1 class="text-primary mt-4">Nossa História</h1>
              </div>
            </div>
