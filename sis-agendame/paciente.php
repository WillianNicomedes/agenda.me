...
<header class="bg-dark">
            <nav class="navbar navbar-expand-lg  navbar-dark" style="background-color: #135B7D;">
                ...
                <div class="collapse navbar-collapse" id="conteudoNavbarSuportado">
                    ...
                    <li class="nav-item"><a href="paciente.php?menuop=home" class="nav-link active">Home</a></li>
                        <li class="nav-item"><a href="paciente.php?menuop=cad-contato" class="nav-link">Contato</a></li>
                    </ul>
                </div>
            </nav>
    </header>
