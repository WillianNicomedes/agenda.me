    ...
    <form action="index.php?menuop=atualizar-contato" method="POST">
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                ...
                <input class="form-control" type="text" id="nomeContato" name="nomeContato" maxlength="50" required value="<?=$dados['nomeContato']?>">
            </div>
        </div>
        <div class="mb-3">
            ...
            <div class="input-group">
                ...
                <input class="form-control" type="email" name="emailContato" maxlength="50" required value="<?=$dados['emailContato']?>">
            </div>
        </div>
        <div class="mb-3">
            ...
            <div class="input-group">
                ...
                <input class="form-control" type="text" name="telefoneContato"  maxlength="11" required value="<?=$dados['telefoneContato']?>">
            </div>
        </div>
        <div class="mb-3">
        ...
        <div class="row mb-3">
                        <div class="mb-3 col-3">
                            ...
                            <select class="form-select"  name="sexoContato"  required id="sexoContato">
                        ...
                        <div class="mb-3 col-3">
                            ...
                            <input class="form-control" type="date" name="dataNascContato"  required value="<?=$dados['dataNascContato']?>">
                        </div>
                        </div>
        <div class="mb-3">
