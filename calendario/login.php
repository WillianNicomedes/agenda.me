...
<head>
    ...
    <link rel="shortcut icon" href="../informacao/images/agenda.ico" type="image/x-icon">
...
<body style="background-color:#DFE8FF">
                    ...
                    <form role="form" method="post">
                        <fieldset>
                            <div class="form-group">
                                <input class="form-control" placeholder="Digite seu usuário" name="usuario" type="username" required>
                            </div>
                            <div class="form-group">
                                <input class="form-control" placeholder="Digite sua senha" name="senha" type="password" required>
                            </div>
