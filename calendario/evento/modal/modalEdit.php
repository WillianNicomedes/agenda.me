		  ...
		  <div class="modal-dialog" role="document">
			...
			<form class="form-horizontal" method="POST" action="evento/action/eventoEdit.php" onsubmit="return validaForm(this);">
			  <div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Agendamento de Consultas</h4>
			  ...
			  <div class="modal-body">
				  ...
				  <div class="form-group">
					...
					<div class="col-sm-10">
					  <textarea type="text" name="descricao" class="form-control" id="descricao" placeholder="Descrição" required></textarea>
					</div>
				  </div>
				  ...
				  <div class="form-group">
					<label for="convidado" class="col-sm-2 control-label">Profissional</label>
					<div class="col-sm-10">
				  ...
				  <div class="form-group">
					...
					<div class="col-sm-10">
					  ...
					  <option value="">Nenhum psicólogo</option>
					  <?php
				  ...
				  <div class="form-group">
				    ...
				    <div class="form-group"> 
						<div class="col-sm-offset-2 col-sm-10">
						  <div class="checkbox">
							<label class="text-danger"><input type="checkbox"  name="delete"> Deletar consulta</label>
						  </div>
						</div>
					</div>
